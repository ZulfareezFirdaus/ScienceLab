        ...
        <div class="row">
          ...
          <div class="col-md-5" data-aos="fade-up" data-aos-delay="200" >
            <div class="row">
              ...
              <div class="row">
                <div class="col-md-12 form-group">
                  <select  id="form" placeholder="Form" class="form-control " >
                      <option value="" > Form</option> 
                      <option value="4" > Form 4</option> 
                    <option value="5" > Form 5</option> 
                  </select>
                  <span class="alerts" id="alertForm"></span>
                </div>
              </div>
              <div class="row">
                <div class="col-md-12 form-group">
                  <select  id="classes" placeholder="Class" class="form-control " >
                  ...
                  <span class="alerts" id="alertclass"></span>
                </div>
              </div>
              <div class="row">
                <div class="col-md-12 form-group">
                    <center>
                      <button type="button" id="submitBtn" class="custom-btn btn-12"><span>Lets Go! <i class="fa fa-rocket"></i></span><span> Next </span></button><br><br><br>
                        <a href="signupTeacher.php" style="color: #322f5d;font-weight: 700;">I'm Teacher</a>
                    </center>
                </div>
              </div>
        ...
        $(document).ready(function(){ 
              ...
              $('#submitBtn').click(function(){
                   ...
                   {  
                        ...
                        $('#alertForm').html('<span class="text-danger alerts">Please choose the form!</span>').show(); 
                        $('#alertclass').html('<span class="text-danger alerts">Please choose the class!</span>').show();
                   }
                   if(name != '')  
                   {  
                        $('#alertName').hide(); 
                   ...
                   if($.trim(name).length > 0 && $.trim(icno).length >= 12 && form != '' && classes != '') 
                   {
                       $.ajax({
                        url:"login-process.php",
                        method:"POST",
                        dataType:"json",
                        data:{name:name,icno:icno,form:form,classes:classes,personalData:personalData},
                        success:function(data)
                        {
                            if(data == 'ExistPass')  {  
                                $('#alertExist').hide();
                                location.href = "passwordSet.php";
