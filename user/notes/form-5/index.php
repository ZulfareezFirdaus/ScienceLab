                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown active">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="menu-icon fa fa-book"></i><a href="./">Form 5</a></li>
                        </ul>
                    </li>
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <li class="active" >Notes Form 5</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="content mt-3">
            <div class="col-xl-12 col-lg-12">
                <div class="card title-page">
                    <div class="card text-light bg-notes-form5">
                        <div class="card-body">
                            <div class="title" >NOTES <span>Form 5</span></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-12 col-lg-12 theme-subject">
                <div class="alert alert-success bg-theme-notes-form5" role="alert">
                    <h4 class="alert-heading theme-title">Tema 1 : Penyenggaraan dan Kesinambungan Hidup</h4>
                </div>
            </div>
            ...
            <div class="col-lg-4">
                <a href="bab-1/">
                    <div class="card chapter-subject">
                        <div class="media">
                            <div class="bg-color-chapter-notes-form5-img" >
                                <img class="align-self-center mr-3 bg-notes" alt="" src="../../images/main-bg/notes/form-5/mb-01.jpg">
                            </div>
                            <div class="notes-body tooltips">
                                <h2 class="display-6">BAB 1</h2>
                                <p>MIKROORGANISMA</p>
                                <span class="tooltiptexts">MIKROORGANISMA</span>
                            </div>
                        </div>
                    </div>
                </a>
            ...
            <div class="col-lg-4">
                <a href="bab-2/">
                    <div class="card chapter-subject">
                        <div class="media">
                            <div class="bg-color-chapter-notes-form5-img" >
                                <img class="align-self-center mr-3 bg-notes" alt="" src="../../images/main-bg/notes/form-5/mb-02.jpg">
                            </div>
                            <div class="notes-body tooltips">
                                <h2 class="display-6">BAB 2</h2>
                                <p>NUTRISI DAN TEKNOLOGI MAKANAN</p>
                                <span class="tooltiptexts">NUTRISI DAN TEKNOLOGI MAKANAN</span>
                            </div>
                        </div>
                    </div>
                </a>
            ...
            <div class="col-lg-4">
                <a href="bab-3/">
                    <div class="card chapter-subject">
                        <div class="media">
                            <div class="bg-color-chapter-notes-form5-img" >
                                <img class="align-self-center mr-3 bg-notes" alt="" src="../../images/main-bg/notes/form-5/mb-03.jpg">
                            </div>
                            <div class="notes-body tooltips">
                                <h2 class="display-6">BAB 3</h2>
                                <p>KELESTARIAN ALAM SEKITAR</p>
                                <span class="tooltiptexts">KELESTARIAN ALAM SEKITAR</span>
                            </div>
                        </div>
                    </div>
                </a>
