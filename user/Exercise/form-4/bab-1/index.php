                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <li ><a href="../">Exercise Form 4</a></li>
        ...
        <div class="content mt-3">
            <div class="col-xl-12 col-lg-12">
                <div class="card header-theme">
                    <div class="media media-exercise-form4">
                        <div class="bg-header-theme-img-exercise-form4" >
                            <img class="align-self-center mr-3 header-theme-img-exercise-form4" alt="" src="../../../images/main-bg/exercise/form-4/mb-01.jpg">
                        </div>
