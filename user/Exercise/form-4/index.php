            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown active">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i style="color:#ffffff!important" class="menu-icon fa fas fa-pencil-alt" ></i>Exercise</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fas fa-pencil-alt"></i><a href="./">Form 4</a></li>
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <li class="active" >Exercise Form 4</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="content mt-3">
            <div class="col-xl-12 col-lg-12">
                <div class="card title-page">
                    <div class="card text-light bg-exercise-form4">
                        <div class="card-body">
                            <div class="title" >EXERCISE <span>Form 4</span></div>
                        </div>
                    </div>
                </div>
            </div>
            
            <div class="col-xl-12 col-lg-12 theme-subject">
                <div class="alert alert-success bg-theme-exercise-form4" role="alert">
                    <h4 class="alert-heading theme-title">Tema 1 : Kaedah Saintifik</h4>
                </div>
            </div>
                
            <div class="col-lg-4">
                <a href="bab-1/">
                    <div class="card chapter-subject">
                        <div class="media">
                            <div class="bg-color-chapter-exercise-form4-img" >
                                <img class="align-self-center mr-3 bg-exercise" alt="" src="../../images/main-bg/exercise/form-4/mb-01.jpg">
                            </div>
                            <div class="notes-body tooltips">
                                <h2 class="display-6">BAB 1</h2>
                                <p>LANGKAH KESELAMATAN DI DALAM MAKMAL</p>
                                <span class="tooltiptexts">LANGKAH KESELAMATAN DI DALAM MAKMAL</span>
                            </div>
                        </div>
                    </div>
                </a>
            ...
            <div class="col-lg-4">
                <a href="bab-2/">
                    <div class="card chapter-subject">
                        <div class="media">
                            <div class="bg-color-chapter-exercise-form4-img" >
                                <img class="align-self-center mr-3 bg-exercise" alt="" src="../../images/main-bg/exercise/form-4/mb-02.jpg">
                            </div>
                            <div class="notes-body tooltips">
                                <h2 class="display-6">BAB 2</h2>
                                <p>BANTUAN KECEMASAN</p>
                                <span class="tooltiptexts">BANTUAN KECEMASAN</span>
                            </div>
                        </div>
                    </div>
                </a>
            ...
            <div class="col-lg-4">
                <a href="bab-3/">
                    <div class="card chapter-subject">
                        <div class="media">
                            <div class="bg-color-chapter-exercise-form4-img" >
                                <img class="align-self-center mr-3 bg-exercise" alt="" src="../../images/main-bg/exercise/form-4/mb-03.jpg">
                            </div>
                            <div class="notes-body tooltips">
                                <h2 class="display-6">BAB 3</h2>
                                <p>TEKNIK MENGUKUR PARAMETER KESIHATAN BADAN</p>
                                <span class="tooltiptexts">TEKNIK MENGUKUR PARAMETER KESIHATAN BADAN</span>
                            </div>
                        </div>
                    </div>
                </a>
