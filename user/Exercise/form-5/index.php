                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown active">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="menu-icon fa fas fa-pencil-alt"></i><a href="./">Form 5</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children dropdown">
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <li class="active" >Exercise Form 5</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="content mt-3">
            <div class="col-xl-12 col-lg-12">
                <div class="card title-page">
                    <div class="card text-light bg-exercise-form5">
                        <div class="card-body">
                            <div class="title" style="text-align:left;">EXERCISE <span>Form 5</span></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-12 col-lg-12 theme-subject">
                <div class="alert alert-success bg-theme-exercise-form5" role="alert">
            ...
            <div class="col-lg-4">
                <a href="bab-1/">
                    <div class="card chapter-subject">
                        <div class="media">
                            <div class="bg-color-chapter-exercise-form5-img" >
                                <img class="align-self-center mr-3 bg-exercise" alt="" src="../../images/bg-16.jpg">
                            </div>
            ...
            <div class="col-lg-4">
                <a href="bab-2/">
                    <div class="card chapter-subject">
                        <div class="media">
                            <div class="bg-color-chapter-exercise-form5-img" >
                                <img class="align-self-center mr-3 bg-exercise" alt="" src="../../images/bg-17.jpg">
                            </div>
                            <div class="notes-body">
            ...
            <div class="col-lg-4">
                <a href="bab-3/">
                    <div class="card chapter-subject">
                        <div class="media">
                            <div class="bg-color-chapter-exercise-form5-img" >
                                <img class="align-self-center mr-3 bg-exercise" alt="" src="../../images/bg-18.jpg">
                            </div>
                            <div class="notes-body">
